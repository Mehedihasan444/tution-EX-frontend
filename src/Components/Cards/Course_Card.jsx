...
const Course_Card = ({ course }) => {
  ...
  return (
    ...
    <div className="rounded-2xl bg-white  border  shadow cursor-pointer ">
        <div className="">
        <img
          src={course?.img}
          alt="course image"
          className=" object-cover h-[229px] rounded-t-2xl"
        />
      </div>
      <div className="p-5  pt-0 space-y-2">
        <div className="">
          <div className="flex flex-row items-center  gap-3">
            ...
            <span className="font-bold">({course?.rating?.total_rating})</span>
          </div>
        ...
        <div className="flex flex-row justify-between items-center gap-5 pt-2">
          <div className="flex flex-row items-center justify-between gap-3">
            ...
            <span className=" font-bold">{course?.author?.name}</span>
          </div>
          <div className="">
