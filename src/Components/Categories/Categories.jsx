...
const Categories=()=>{
    return(
        <section className='pt-10 space-y-3 bg-[#0B033C] text-white rounded-md'>
            <h1 className='text-4xl md:text-6xl font-bold text-center'>Our Featured Categories</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 mx-auto  p-16 gap-5">

                <div className='bg-[#191248] p-7 flex flex-col justify-center items-center rounded-lg cursor-pointer hover:scale-105'>
